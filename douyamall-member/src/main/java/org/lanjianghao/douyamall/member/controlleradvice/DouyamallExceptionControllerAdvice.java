package org.lanjianghao.douyamall.member.controlleradvice;
 ...
 */
@Slf4j
@RestControllerAdvice("org.lanjianghao.douyamall.member.controller")
public class DouyamallExceptionControllerAdvice {
    ...
    public R handleValidException(MethodArgumentNotValidException e) {
        ...
        log.debug("数据校验不通过：{}， 异常类型：{}", e.getMessage(), e.getClass());
    ...
    public R handleApplicationException(ApplicationException e) {
        log.debug("异常：{}。类型：{}", e.getMessage(), e.getClass().getSimpleName());
